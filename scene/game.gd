...
const RESULT_MESSAGE_WIN := "你成功坚持到了游戏结束"
const RESULT_MESSAGE_LOSE := "玩家生命值已归零"
const RESULT_OK_BOTTOM_TEXT := "结束游戏"
...
@onready var result_lost_sfx_player: AudioStreamPlayer = $AudioContainer/ResultLostSfxPlayer
...
func _configure_result_dialog() -> void:
	...
	result_dialog.ok_button_text = RESULT_OK_BOTTOM_TEXT
	result_dialog.hide()
...
func _update_hud() -> void:
	_update_life_count_lable()
	_update_time_bar()


func _update_life_count_lable() -> void:
...
func _play_result_audio(result_title: String) -> void:
	...
	if result_title == RESULT_TITLE_LOSE:
		_play_sfx(result_lost_sfx_player)
...
func _collect_enemy_spawn_points() -> void:
	...
	if enemy_spawn_points.is_empty():
		push_warning("Game/MissingSpawnPoints")
...
func _collect_enemy_configs() -> void:
	...
	if available_enemy_configs.is_empty():
		push_warning("Game/MissingEnemyConfig")
